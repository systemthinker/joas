...
@section('home')
    ...
    <div class="col-md-6 offset-2">
        ...
        <h5>Video oversluiter alleenstaand</h5>
    ...
    <div>
        <a class="nav-link" href="{{route('oversluiterAlleenstaandOndernemer')}}"><button class="btn btn-block btn-success">Ik ben ondernemer</button></a>

    </div>
    <div >

        <a class="nav-link" href="{{route('oversluiterAlleenstaandParticulier')}}"><button class="btn btn-block btn-success">Ik ben een particulier</button></a>
