...
@section('home')
    ...
    <div class="col-md-6 offset-2">
        ...
        <h5>Video eerste woning met kind</h5>
        ...
        <p>Uitleg algemeen eerste woning met kind
        ...
        <div>
            <a class="nav-link" href="{{route('woningKindOndernemer')}}"><button class="btn btn-block btn-success">Ik ben ondernemer</button></a>

        </div>
        <div >

            <a class="nav-link" href="{{route('woningKindParticulier')}}"><button class="btn btn-block btn-success">Ik ben een particulier</button></a>
