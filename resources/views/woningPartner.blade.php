...
@section('home')
    ...
    <div class="col-md-6 offset-2">
        ...
        <div>
            <a class="nav-link" href="{{route('woningPartnerOndernemer')}}"><button class="btn btn-block btn-success">Ik ben ondernemer</button></a>

        </div>
        <div >

            <a class="nav-link" href="{{route('woningPartnerParticulier')}}"><button class="btn btn-block btn-success">Ik ben een particulier</button></a>
